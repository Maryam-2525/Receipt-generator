            ...
            dropdownMenu.innerHTML = `
                <div class="social-media-options">
                    <button class="share-option" data-type="whatsapp">
                        <img src="assets/icons/whatsapp.svg" alt="WhatsApp" class="share-icon">
                    </button>
                    <button class="share-option" data-type="facebook">
                        <img src="assets/icons/facebook.svg" alt="Facebook" class="share-icon">
                    </button>
                    <button class="share-option" data-type="instagram">
                        <img src="assets/icons/instagram.svg" alt="Instagram" class="share-icon">
                    </button>
                    <button class="share-option" data-type="email">
                        <img src="assets/icons/email.svg" alt="Email" class="share-icon">
                    </button>
                </div>
                <div class="share-divider"></div>
                <div class="save-options">
                    <button class="share-option" data-type="image">
                        <img src="assets/icons/image.svg" alt="Save as Image" class="share-icon">
                    </button>
                    <button class="share-option" data-type="pdf">
                        <img src="assets/icons/pdf.svg" alt="Save as PDF" class="share-icon">
                    </button>
                </div>
            `;
